...
import { useClientListStore } from "../stores/clientListStore"
import { postApiClientSearchOptions } from "@/shared/api/@tanstack/react-query.gen"
...
export const useClientList = () => {
    ...
    useEffect(() => {
        if (query.isError) {
            toast.error(t("client.messages.search.error"))
        }
