...
type SearchClientRequest = z.infer<typeof zSearchClientRequest>
export interface ClientFilters extends Omit<SearchClientRequest, "pageNumber" | "pageSize" | "sortBy" | "sortDirection"> { }
...
export const useClientListStore = create<ClientListState & ClientListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
