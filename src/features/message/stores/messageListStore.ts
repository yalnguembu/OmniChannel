...
type SearchMessageRequest = z.infer<typeof zSearchMessageRequest>
export interface MessageFilters extends Omit<SearchMessageRequest, "pageNumber" | "pageSize" | "sortBy" | "sortDirection"> { }
...
export const useMessageListStore = create<MessageListState & MessageListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
