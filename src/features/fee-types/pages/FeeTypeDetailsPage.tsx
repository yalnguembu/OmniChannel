...
export function FeeTypeDetailsPage() {
  const navigate = useNavigate()
  const { id } = useParams({ from: `/_protected/administration/fee-types/$id/` })
  const { selectedFeeType: data, getFeeTypeQuery, isLoading, isError } = useFeeType()
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle>FeeType Details</CardTitle>
        </CardHeader>
