...
import { CreateIntegrationSyncLogRequest } from "@/shared/api"
import { zCreateIntegrationSyncLogRequest } from "@/shared/api/zod.gen"
...
interface IntegrationSyncLogCreateFormProps {
  onSubmit: (data: CreateIntegrationSyncLogRequest, setError: any) => void
  onCancel: () => void
  isLoading?: boolean
  defaultValues?: Partial<CreateIntegrationSyncLogRequest>
  
}

export const IntegrationSyncLogCreateForm: React.FC<IntegrationSyncLogCreateFormProps> = ({ 
  onSubmit, 
  onCancel, 
  isLoading = false, 
  defaultValues,
  ...
  const form = useForm<CreateIntegrationSyncLogRequest>({
    resolver: zodResolver(zCreateIntegrationSyncLogRequest),
    defaultValues: {
      ...defaultValues,
  ...
  const handleSubmit = (values: CreateIntegrationSyncLogRequest) => {
    if (onSubmit) {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("integrationSyncLog.form.create.title")}</CardTitle>
        <CardDescription>{t("integrationSyncLog.form.create.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
    ...
    />
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              <Button type="submit" disabled={isLoading}>
                ...
                {t("integrationSyncLog.form.create.submit")}
              </Button>
            </div>
          </form>
        </Form>
