...
interface SecureSettingListState {
    viewMode: "grid" | "list"
...
interface SecureSettingListActions {
...
const initialState: SecureSettingListState = {
    viewMode: "list",
...
export const useSecureSettingListStore = create<SecureSettingListState & SecureSettingListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
