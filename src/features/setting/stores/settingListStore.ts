...
const initialState: SettingListState = {
    viewMode: "list",
...
export const useSettingListStore = create<SettingListState & SettingListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
