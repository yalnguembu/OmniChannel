...
interface SettingCreateFormProps {
  onSubmit: (data: CreateSettingRequest, setError: any) => void
  onCancel: () => void
  isLoading?: boolean
...
export const SettingCreateForm: React.FC<SettingCreateFormProps> = ({ 
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("setting.form.create.title")}</CardTitle>
        <CardDescription>{t("setting.form.create.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
