...
import { TrendingUp, DollarSign, Activity, CreditCard, Wallet, PiggyBank, Zap, Percent, CheckCircle, AlertCircle } from "lucide-react"
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("analytics.enhanced.totalEcosystemValue")}</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("analytics.overview.overallSuccessRate")}</CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 text-xs text-muted-foreground">
              ...
              {t("analytics.overview.failureRate")}: {effectiveMetrics.failureRate || 0}%
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("analytics.overview.profitMargin")}</CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 text-xs text-muted-foreground">
              ...
              {t("analytics.overview.net")}: {(((effectiveMetrics.totalFees || 0) - (effectiveMetrics.totalProviderFees || 0)) / 1000).toFixed(0)}K XAF
            </div>
          </CardContent>
        </Card>
