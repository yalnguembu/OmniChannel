...
type SearchProviderRequest = z.infer<typeof zSearchProviderRequest>
export interface ProviderFilters extends Omit<SearchProviderRequest, "pageNumber" | "pageSize" | "sortBy" | "sortDirection"> { }
...
export const useProviderListStore = create<ProviderListState & ProviderListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
