...
type SearchFileRequest = z.infer<typeof zSearchFileRequest>
export interface FileFilters extends Omit<SearchFileRequest, "pageNumber" | "pageSize" | "sortBy" | "sortDirection"> { }
