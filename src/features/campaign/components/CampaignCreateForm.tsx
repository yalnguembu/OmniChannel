...
import { CreateCampaignRequest } from "@/shared/api"
import { zCreateCampaignRequest } from "@/shared/api/zod.gen"
...
interface CampaignCreateFormProps {
  onSubmit: (data: CreateCampaignRequest, setError: any) => void
  onCancel: () => void
  isLoading?: boolean
  defaultValues?: Partial<CreateCampaignRequest>
...
export const CampaignCreateForm: React.FC<CampaignCreateFormProps> = ({ 
  ...
  const form = useForm<CreateCampaignRequest>({
    resolver: zodResolver(zCreateCampaignRequest),
    defaultValues: {
      ...defaultValues,
  ...
  const handleSubmit = (values: CreateCampaignRequest) => {
    if (onSubmit) {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("campaign.form.create.title")}</CardTitle>
        <CardDescription>{t("campaign.form.create.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
