...
import { useCampaignListStore } from "../stores/campaignListStore"
import { postApiCampaignSearchOptions } from "@/shared/api/@tanstack/react-query.gen"
...
export const useCampaignList = () => {
    ...
    useEffect(() => {
        if (query.isError) {
            toast.error(t("campaign.messages.search.error"))
        }
