...
import { SearchCountryResponse } from "@/shared/api/types.gen"
...
export const useCountryListStore = create<CountryListState & CountryListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
