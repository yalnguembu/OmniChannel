...
import { useNotificationListStore } from "../stores/notificationListStore"
import { postApiNotificationSearchOptions } from "@/shared/api/@tanstack/react-query.gen"
...
export const useNotificationList = () => {
    ...
    useEffect(() => {
        if (query.isError) {
            toast.error(t("notification.messages.search.error"))
        }
