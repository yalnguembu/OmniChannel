...
export const SecureSettingCreateForm: React.FC<SecureSettingCreateFormProps> = ({ onSubmit, onCancel, isLoading = false }) => {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("secureSettings.form.create.title")}</CardTitle>
        <CardDescription>{t("secureSettings.form.create.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("secureSettings.form.nameLabel", "Setting Group Name")}</FormLabel>
                  <FormControl>
                    <Input type="text" placeholder={t("secureSettings.form.namePlaceholder", "Enter setting group name")} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input type="text" placeholder={t("secureSettings.form.keyPlaceholder", "Enter key")} {...field} value={field.value || ""} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                              ...
                              {(() => {
                                ...
                                return (
                                  <div className="relative">
                                    <Input type={inputType} placeholder={t("secureSettings.form.secureValuePlaceholder", "Enter value")} {...field} value={field.value || ""} />
                                    <Button
                                      type="button"
                                      variant="ghost"
