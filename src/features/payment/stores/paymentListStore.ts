...
type SearchPaymentRequest = z.infer<typeof zSearchPaymentRequest>
export interface PaymentFilters extends Omit<SearchPaymentRequest, "pageNumber" | "pageSize" | "sortBy" | "sortDirection"> { }
...
export const usePaymentListStore = create<PaymentListState & PaymentListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
