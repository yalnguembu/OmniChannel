...
import { usePaymentListStore } from "../stores/paymentListStore"
import { postApiPaymentSearchOptions } from "@/shared/api/@tanstack/react-query.gen"
...
export const usePaymentList = () => {
    ...
    useEffect(() => {
        if (query.isError) {
            toast.error(t("payment.messages.search.error"))
        }
