...
import { EditIntegrationRequest } from "@/shared/api"
import { zEditIntegrationRequest } from "@/shared/api/zod.gen"
...
interface IntegrationEditFormProps {
  onSubmit: (data: EditIntegrationRequest, setError: any) => void
  onCancel: () => void
  isLoading?: boolean
  defaultValues?: Partial<EditIntegrationRequest>
  initialData?: Partial<EditIntegrationRequest>
}

export const IntegrationEditForm: React.FC<IntegrationEditFormProps> = ({ 
  onSubmit, 
  onCancel, 
  isLoading = false, 
  defaultValues,
  ...
  const form = useForm<EditIntegrationRequest>({
    resolver: zodResolver(zEditIntegrationRequest),
    defaultValues: {
      ...defaultValues,
      ...initialData,
    },
  ...
  const handleSubmit = (values: EditIntegrationRequest) => {
    if (onSubmit) {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("integration.form.edit.title")}</CardTitle>
        <CardDescription>{t("integration.form.edit.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
    ...
    />
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              <Button type="submit" disabled={isLoading}>
                ...
                {t("integration.form.edit.submit")}
              </Button>
            </div>
          </form>
        </Form>
