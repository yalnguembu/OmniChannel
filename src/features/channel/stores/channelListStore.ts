...
type SearchChannelRequest = z.infer<typeof zSearchChannelRequest>
export interface ChannelFilters extends Omit<SearchChannelRequest, "pageNumber" | "pageSize" | "sortBy" | "sortDirection"> { }
...
export const useChannelListStore = create<ChannelListState & ChannelListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
