...
import { CreateCompanyVerificationRequest } from "@/shared/api"
import { zCreateCompanyVerificationRequest } from "@/shared/api/zod.gen"
...
interface CompanyVerificationCreateFormProps {
  onSubmit: (data: CreateCompanyVerificationRequest, setError: any) => void
  onCancel: () => void
  isLoading?: boolean
  defaultValues?: Partial<CreateCompanyVerificationRequest>
  
}

export const CompanyVerificationCreateForm: React.FC<CompanyVerificationCreateFormProps> = ({ 
  onSubmit, 
  onCancel, 
  isLoading = false, 
  defaultValues,
  ...
  const form = useForm<CreateCompanyVerificationRequest>({
    resolver: zodResolver(zCreateCompanyVerificationRequest),
    defaultValues: {
      ...defaultValues,
  ...
  const handleSubmit = (values: CreateCompanyVerificationRequest) => {
    if (onSubmit) {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("companyVerification.form.create.title")}</CardTitle>
        <CardDescription>{t("companyVerification.form.create.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
    ...
    />
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              <Button type="submit" disabled={isLoading}>
                ...
                {t("companyVerification.form.create.submit")}
              </Button>
            </div>
          </form>
        </Form>
