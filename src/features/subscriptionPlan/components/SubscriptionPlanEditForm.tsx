...
import { EditSubscriptionPlanRequest } from "@/shared/api"
import { zEditSubscriptionPlanRequest } from "@/shared/api/zod.gen"



interface SubscriptionPlanEditFormProps {
  onSubmit: (data: EditSubscriptionPlanRequest, setError: any) => void
  onCancel: () => void
  isLoading?: boolean
  defaultValues?: Partial<EditSubscriptionPlanRequest>
  initialData?: Partial<EditSubscriptionPlanRequest>
}

export const SubscriptionPlanEditForm: React.FC<SubscriptionPlanEditFormProps> = ({ 
  onSubmit, 
  onCancel, 
  isLoading = false, 
  defaultValues,
  ...
  const form = useForm<EditSubscriptionPlanRequest>({
    resolver: zodResolver(zEditSubscriptionPlanRequest),
    defaultValues: {
      ...defaultValues,
      ...initialData,
    },
  ...
  const handleSubmit = (values: EditSubscriptionPlanRequest) => {
    if (onSubmit) {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("subscriptionPlan.form.edit.title")}</CardTitle>
        <CardDescription>{t("subscriptionPlan.form.edit.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
    ...
    />
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              <Button type="submit" disabled={isLoading}>
                ...
                {t("subscriptionPlan.form.edit.submit")}
              </Button>
            </div>
          </form>
        </Form>
