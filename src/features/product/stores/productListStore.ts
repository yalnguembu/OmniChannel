...
import { z } from "zod"
import { zSearchProductRequest } from "@/shared/api/zod.gen"
import { SearchProductResponse } from "@/shared/api/types.gen"

type SearchProductRequest = z.infer<typeof zSearchProductRequest>
export interface ProductFilters extends Omit<SearchProductRequest, "pageNumber" | "pageSize" | "sortBy" | "sortDirection"> { }
...
export const useProductListStore = create<ProductListState & ProductListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
