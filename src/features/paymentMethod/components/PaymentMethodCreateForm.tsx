...
interface PaymentMethodCreateFormProps {
  onSubmit: (data: CreatePaymentMethodRequest, setError: any) => void
  onCancel: () => void
  isLoading?: boolean
...
export const PaymentMethodCreateForm: React.FC<PaymentMethodCreateFormProps> = ({ 
  onSubmit, 
  onCancel, 
  isLoading = false, 
  defaultValues,
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("paymentMethod.form.create.title")}</CardTitle>
        <CardDescription>{t("paymentMethod.form.create.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
    ...
    />
            ...
            <div className="flex justify-end space-x-4 pt-6">
              ...
              <Button type="submit" disabled={isLoading}>
                ...
                {t("paymentMethod.form.create.submit")}
              </Button>
            </div>
          </form>
        </Form>
