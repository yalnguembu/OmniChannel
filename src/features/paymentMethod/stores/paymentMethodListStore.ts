...
interface PaymentMethodListActions {
...
const initialState: PaymentMethodListState = {
    viewMode: "list",
...
export const usePaymentMethodListStore = create<PaymentMethodListState & PaymentMethodListActions>()(
    devtools(
        immer((set) => ({
            ...initialState,
