...
export const CurrencyCreateForm: React.FC<CurrencyCreateFormProps> = ({ onSubmit, onCancel, isLoading = false }) => {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>{t("currencies.form.create.title")}</CardTitle>
        <CardDescription>{t("currencies.form.create.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
