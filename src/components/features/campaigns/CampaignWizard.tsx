...
export function CampaignWizard({ onClose, productId }: CampaignWizardProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#FBFBFC] overflow-hidden">
      <WizardHeader
      ...
      <main className="flex-1 overflow-y-auto p-8 scrollbar-custom">
      ...
      <TemplateModal
        ...
        editing={null}
        onSubmit={(data) => wizard.createTemplateMutation.mutate(data)}
