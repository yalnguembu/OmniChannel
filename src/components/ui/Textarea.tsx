    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            'w-full px-3 py-2 border rounded-md text-[13px] text-[#0D2137] bg-white outline-none transition-all duration-150 placeholder:text-[#8BAFC0] resize-y min-h-[80px]',
            error
